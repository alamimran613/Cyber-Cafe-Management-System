...
Begin VB.Form system7 
   ...
   Begin VB.Label Label8 
      BackStyle       =   0  'Transparent
      Caption         =   "Time Management of System No. 7"
      BeginProperty Font 
         Name            =   "Comic Sans MS"
         Size            =   12.75
         Charset         =   0
...
Homepage.command7.BackColor = vbRed
...
If (ans = vbYes) Then
Unload Me
Homepage.command7.BackColor = vbGreen
End If
End Sub
...
hh = hh + 1
mm = 0
Homepage.command7.BackColor = vbYellow
End If
End If
