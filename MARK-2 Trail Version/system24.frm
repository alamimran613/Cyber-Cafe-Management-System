VERSION 5.00
Begin VB.Form system24 
   BackColor       =   &H00E3FDFD&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "System No. 24"
   ClientHeight    =   3255
   ClientLeft      =   255
   ClientTop       =   1740
   ClientWidth     =   8805
   ...
   Begin VB.Label Label8 
      BackStyle       =   0  'Transparent
      Caption         =   "Time Management of System No. 24"
      BeginProperty Font 
         Name            =   "Comic Sans MS"
         Size            =   12.75
         Charset         =   0
...
Homepage.command24.BackColor = vbRed
...
If (ans = vbYes) Then
Unload Me
Homepage.command24.BackColor = vbGreen
End If
End Sub
...
hh = hh + 1
mm = 0
Homepage.command24.BackColor = vbYellow
End If
End If
