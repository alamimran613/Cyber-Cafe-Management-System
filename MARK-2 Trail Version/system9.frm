...
Begin VB.Form system9 
   ...
   Begin VB.Label Label8 
      BackStyle       =   0  'Transparent
      Caption         =   "Time Management of System No. 9"
      BeginProperty Font 
         Name            =   "Comic Sans MS"
         Size            =   12.75
         Charset         =   0
...
Homepage.command9.BackColor = vbRed
...
If (ans = vbYes) Then
Unload Me
Homepage.command9.BackColor = vbGreen
End If
End Sub
...
hh = hh + 1
mm = 0
Homepage.command9.BackColor = vbYellow
End If
End If
