...
Begin VB.Form system2 
   ...
   Begin VB.Label Label8 
      BackStyle       =   0  'Transparent
      Caption         =   "Time Management of System No. 2"
      BeginProperty Font 
         Name            =   "Comic Sans MS"
         Size            =   12.75
         Charset         =   0
...
Homepage.Command2.BackColor = vbRed
...
If (ans = vbYes) Then
Unload Me
Homepage.Command2.BackColor = vbGreen
End If
End Sub
...
hh = hh + 1
mm = 0
Homepage.Command2.BackColor = vbYellow
End If
End If
