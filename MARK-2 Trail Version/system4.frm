...
Begin VB.Form system4 
   ...
   ControlBox      =   0   'False
   Icon            =   "system4.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   2946.336
   ScaleMode       =   0  'User
   ScaleWidth      =   8994.864
   ...
   Begin VB.Label Label8 
      BackStyle       =   0  'Transparent
      Caption         =   "Time Management of System No. 4"
      BeginProperty Font 
         Name            =   "Comic Sans MS"
         Size            =   12.75
         Charset         =   0
...
Homepage.Command4.BackColor = vbRed
...
If (ans = vbYes) Then
Unload Me
Homepage.Command4.BackColor = vbGreen
End If
End Sub
...
hh = hh + 1
mm = 0
Homepage.Command4.BackColor = vbYellow
End If
End If
