...
Begin VB.Form system3 
   ...
   Begin VB.Label Label8 
      BackStyle       =   0  'Transparent
      Caption         =   "Time Management of System No. 3"
      BeginProperty Font 
         Name            =   "Comic Sans MS"
         Size            =   12.75
         Charset         =   0
...
Homepage.Command3.BackColor = vbRed
...
If (ans = vbYes) Then
Unload Me
Homepage.Command3.BackColor = vbGreen
End If
End Sub
...
hh = hh + 1
mm = 0
Homepage.Command3.BackColor = vbYellow
End If
End If
