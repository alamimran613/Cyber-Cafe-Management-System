...
Begin VB.Form system5 
   ...
   Begin VB.Label Label8 
      BackStyle       =   0  'Transparent
      Caption         =   "Time Management of System No. 5"
      BeginProperty Font 
         Name            =   "Comic Sans MS"
         Size            =   12.75
         Charset         =   0
...
Homepage.command5.BackColor = vbRed
...
If (ans = vbYes) Then
Unload Me
Homepage.command5.BackColor = vbGreen
End If
End Sub
...
hh = hh + 1
mm = 0
Homepage.command5.BackColor = vbYellow
End If
End If
